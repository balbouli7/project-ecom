...
module.exports = {
    ...
    postDataBookModel : ( title, description, author, livre, cover) => {
        return new Promise((resolve, reject) => {
            let book = new Book({
                title,
                description,
    ...
    postUpdateBookModel: (bookId, title, description, author, livre, cover) => {
        return new Promise((resolve, reject) => {
            Book.updateOne(
                { _id: bookId },
                { title, description, author, livre, cover } // Supprime price
            )
